...
class EfsShell:
    def __init__(self, diag_input: BaseInput, fs_type: str = 'efs'):
        ...
        self.sub_parser_command_name_to_command_object: Dict[
            str, BaseEfsShellCommand
        ] = {}
            ...
            if line:
                try:
                    ...
                    if (
                        ...
                        try:
                            parsed_args: Namespace = sub_parser.parse_args(
                                sub_parser_args
                            )
                            ...
                            try:
                                command_object.execute_command(
                                    self.diag_input, parsed_args
                                )
